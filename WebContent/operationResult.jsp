...
<head>
    ...
    <a herf="http://localhost:8080/WebContent/login.jsp">return</a>
</head>
<body>
...
<%
    ...
    String test ="<a href=\"http://localhost:8080/WebContent/swap.jsp\">return</a>";
        ...
        if (chk.length == 2) {
            {
                ...
                for (int q = 0; q < 2; q++) {
                    ...
                    if (flag == false) {
                        ...
                        System.out.println("<a href=\"http://localhost:8080/WebContent/login.jsp\">return</a>");
                        return;
                    ...
                    if (flag1 == false) {
                        ...
                        out.println("<a href=\"http://localhost:8080/WebContent/login.jsp\">return</a>");
                        return;
                    ...
                    if (v < 2) {
                        ...
                        out.println("<a herf=\"http://localhost:8080/WebContent/login.jsp\">return</a>");
                        return;
                    }
                    if (sum / 4 > 3.5) {
